    ...
    async execute(interaction) {
        try {
            ...
            if (!interaction.replied && !interaction.deferred) {
                await interaction.reply({ content: 'An error occurred trying to report that message.', flags: MessageFlags.Ephemeral });
            } else {
                await interaction.followUp({ content: 'An error occurred trying to report that message.', flags: MessageFlags.Ephemeral });
            }
        }
    }
}